        ...
        try:
            ...
            try:
                ...
                if isinstance(project, dict):
                    project_lower = {k.lower(): v for k, v in project.items()}
                    project_id = project_lower.get('id')
                else:
        ...
        try:
            ...
            for field in fields:
                ...
                if isinstance(stats, dict):
                    ...
                    total = stats_lower.get('total_records') or 0
                    filled = stats_lower.get('filled') or 0
                else:
                    total = stats[0] if stats else 0
                    filled = stats[1] if stats and len(stats) > 1 else 0
